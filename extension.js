...
function activate(context) {
    console.log('Extension "lightningcss-simple-formatter" is now active!');

    // 注册新的命令 ID
    let disposable = vscode.commands.registerCommand('lightningcss-simple.formatAndMerge', async () => {
